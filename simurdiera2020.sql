...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-11-2020 a las 04:34:33
...
INSERT INTO `proyecto` (`id`, `NombreProyecto`, `FechaInicio`, `StatusActual`, `CodigoNombre`, `Descripcion`) VALUES
(1, 'nuifvfv', 2000, 'acabado', 4567, 'jiofrejifonrv');
...
INSERT INTO `registro` (`id`, `Nombre`, `Apellido`, `FechaRegistro`, `Nacimiento`, `Edad`, `AreaDesarrollo`, `Residencia`, `NivelEstudios`, `CodigoPersonal`) VALUES
...
ALTER TABLE `proyecto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `CodigoNombre` (`CodigoNombre`);
